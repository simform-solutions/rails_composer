...
say_wizard("\033[1m\033[36m" + ' ____  _            __' + "\033[0m")
say_wizard("\033[1m\033[36m" + '/ ___|(_)____ ___  / _| ___  ____ ____ ___ ' + "\033[0m") 
say_wizard("\033[1m\033[36m" + '\___ \| |  _   _ \| |_ / _ \|  __|  _   _ \ ' + "\033[0m")
say_wizard("\033[1m\033[36m" + ' ___) | | | | | | |  _| (_) | |  | | | | | | ' + "\033[0m")
say_wizard("\033[1m\033[36m" + '|____/|_|_| |_| |_|_|  \___/|_|  |_| |_| |_| ' + "\033[0m")
say_wizard("\033[1m\033[36m" + '' + "\033[0m")                                   
...
## Git
say_wizard "This is from recipes"
...
if prefer :apps4, 'learn-rails'
  ...
  stage_three do
    ...
    # copy_from_repo 'config/routes.rb', :repo => repo
    append_to_file 'config/routes.rb', :after => "routes.draw do\n" do
...
## Admin Panel
prefs[:admin] = multiple_choice "Wants Admin Panel?", [["Yes", "yes"],
  ["No", "no"]] unless prefs.has_key? :admin

## Grape Swagger
prefs[:grape_swagger] = multiple_choice "Wants API Structure?", [["Yes", "yes"],
  ["No", "no"]] unless prefs.has_key? :grape_swagger
...
# >--------------------------------[ grape_swagger ]---------------------------------<
@current_recipe = "grape_swagger"
@before_configs["grape_swagger"].call if @before_configs["grape_swagger"]
say_recipe 'grape_swagger'
@configs[@current_recipe] = config
# >---------------------------- recipes/grape_swagger.rb ----------------------------start<
...
stage_two do
  say_wizard "recipe stage two"
  if prefer :grape_swagger, 'yes'
    # Configure Grape and Swagger
    autoload_path_text = <<-TEXT
    # Load/Autoload paths
    config.paths.add File.join('app', 'api'), glob: File.join('**', '*.rb')
    config.autoload_paths += Dir[Rails.root.join('app', 'api', '*')]
    TEXT
   inject_into_file 'config/application.rb', autoload_path_text, :after => "config.load_defaults 5.2"
   create_file 'app/api/api.rb', "
   class API < Grape::API
    prefix 'api'
    format :json
    ...
    mount Endpoints::AdminUsers

    add_swagger_documentation	api_version: 'v1',                          
      info: 
      {
        title: 'Admin User',
        description: 'List of APIs for Admin User'											    
      }
  end"
   create_file 'app/api/endpoints/admin_users.rb',
   "module Endpoints
    ...
    create_file 'config/initializers/swagger.rb', "
    GrapeSwaggerRails.options.url      = '/api/v1/swagger_doc.json'
    GrapeSwaggerRails.options.app_name = 'AdminUser'
...
stage_three do
  ...
  if prefer :authentication, 'devise'
    ...
    append_file 'app/views/layouts/application.html.erb','  <%= render :partial => "layouts/nav_links_for_auth" %>', :after => "<body>\n"if prefer :apps4, 'rails-devise' 
