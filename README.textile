...
| "rails-gallary-demo":https://github.com/simformsolutions/rails_gallary_demo/tree/master | "Rails-gallary-demo":https://github.com/simformsolutions/rails_gallary_demo/tree/master | Authentication, Admin panel, API's demo |
...
<pre>
$ rails new myapp -m https://raw.github.com/simformsolutions/rails_composer/master/composer.rb
</pre>
...
$ gem install rails
$ rails new . -m https://raw.github.com/simformsolutions/rails_composer/master/composer.rb
</pre>
...
option  Choose a starter application.
    1)  rails-gallary-demo
    2)  learn-rails
    3)  rails-bootstrap
    4)  rails-foundation
    5)  rails-mailinglist-activejob
    6)  rails-omniauth
    7)  rails-devise
    8)  rails-devise-roles
    9)  rails-devise-pundit
   10)  rails-signup-download
   11)  rails-stripe-checkout
   12)  rails-stripe-coupons
</pre>
